                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <h5><i class="fa fa-shopping-cart"></i> Detail Pemesanan </h5>
                            <p class="text-right">Tanggal Pesan : {{ $reservasi->created_at }}</p>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('produkdetail.uploadBuktiPembayaran', $reservasi->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
